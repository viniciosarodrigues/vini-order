...
public class ProductController extends BaseController<ProductService> {
    ...
    @GetMapping
    public ResponseEntity<Page<ProductProtocol>> findPage(ProductFilter filters) {
    ...
    @ApiOperation(value = "Busca por identificador", nickname = "find-by-id-product", notes = "Realiza a busca de informações detalhadas de um produto por identificador único do mesmo")
    @GetMapping(path = "/{id}")
